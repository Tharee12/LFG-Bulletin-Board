...
GBB.dungeonTagsLoc={
	...
	deDE =langSplit({
		["RAMPS"] = 	"bollwerk bw" ,
		["BF"]	=	"blutkessel bk"	, 
		["SP"]	=	"sp slave pens sklaven sklavenunterkünfte unterkünfte sklave" ,
		["UB"]	=	"tiefensumpf tiefen" ,
		["MT"]	=	"mana tombs  managruft gruft" ,
		["CRYPTS"] =	"auchen auchi krypta crypta auchenaikrypta" ,
		["RFC"] = 	"rfa ragefireabgrund flammenschlund flamenschlund rf rfg" ,
		["SETH"] =	"sethekhallen hallen" ,
		["OHB"]	=	"vorgebirge hügellands hügelland hdz1 cot1" ,
		["BM"]	= 	"hdz2 morast" ,
		["MECH"] =	"mech mecharnar mechanar" ,
		["MGT"] =	"terasse" ,
